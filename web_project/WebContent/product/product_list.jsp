...
<head>
    <title></title>
    <meta charset="utf-8">
    <link rel="stylesheet" href="/web_project/css/reset.css" type="text/css" media="screen">
    <link rel="stylesheet" href="/web_project/css/style.css" type="text/css" media="screen">
    <link rel="stylesheet" href="/web_project/css/grid.css" type="text/css" media="screen">   
    <script src="/web_project/js/jquery-1.6.2.min.js" type="text/javascript"></script>    
	<!--[if lt IE 7]>
                                        ...
                                        <div class="wrapper">
                                            <div class="grid_12">
                                                ...
                                                <div class="wrapper p4">
                                                    <article class="grid_4 alpha">
                                                        <div class="indent-left">
                                                            <figure class="frame2 p2"><img src="/web_project/images/page4-img1.jpg" alt="" /></figure>
                                                    ...
                                                    <article class="grid_4">
                                                        <div class="indent3">
                                                            <figure class="frame2 p2"><img src="/web_project/images/page4-img2.jpg" alt="" /></figure>
                                                    ...
                                                    <article class="grid_4 omega">
                                                        <div class="indent-right">
                                                            <figure class="frame2 p2"><img src="/web_project/images/page4-img3.jpg" alt="" /></figure>
                                                ...
                                                <div class="wrapper">
                                                    <article class="grid_4 alpha">
                                                        <div class="indent-left">
                                                            <figure class="frame2 p2"><img src="/web_project/images/page4-img4.jpg" alt="" /></figure>
                                                            <p class="color-4 prev-indent-bot">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium.</p>
                                                            <p>Doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta.</p>
                                                            <div class="wrapper">
                                                            	<span class="price fleft">$45.99</span>
                                                    ...
                                                    <article class="grid_4">
                                                        <div class="indent3">
                                                            <figure class="frame2 p2"><img src="/web_project/images/page4-img5.jpg" alt="" /></figure>
                                                            <p class="color-4 prev-indent-bot">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit.</p>
                                                            <p>Sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt eque porro quisquam est, qui dolorem ipsum.</p>
                                                            <div class="wrapper">
                                                            	<span class="price fleft">$54.99</span>
                                                    ...
                                                    <article class="grid_4 omega">
                                                        <div class="indent-right">
                                                            <figure class="frame2 p2"><img src="/web_project/images/page4-img6.jpg" alt="" /></figure>
                                                            <p class="color-4 prev-indent-bot">Feque porro quisquam est, qui dolorem ipsum quia dolor sit consectetur.</p>
                                                            <p>Adipisci velit, sed quia non numquam eius modi tempora incidu labore et dolore magnam aliquam quaerat voluptatem.</p>
                                                            <div class="wrapper">
                                                            	<span class="price fleft">$38.99</span>
            	...
            	<div class="container_12">
                	<div class="wrapper">
                    	<article class="grid_4">
                            ...
                            <div class="wrapper">
                            	<figure class="img-indent frame2"><img src="/web_project/images/page4-img7.jpg" alt="" /></figure>
